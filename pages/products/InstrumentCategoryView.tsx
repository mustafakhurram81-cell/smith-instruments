...
export const InstrumentCategoryView: React.FC = () => {
    ...
    const { data: productsResult, isLoading: productsLoading } = useProductsByInstrument(
        category,
            ...
            <Section className="bg-stone-50 !py-12">
                <div className="container mx-auto px-6">
                    {loading ? (
                        ...
                        <>
                            <h2 className="text-2xl font-heading text-brand-charcoal mb-8">Instrument Types</h2>
