...
export const About: React.FC = () => {
  ...
  return (
    <div className="overflow-x-hidden">
            ...
            <div className="lg:w-7/12 pt-10">
              <FadeIn delay={0.2}>
                ...
                <div className="space-y-6 text-stone-600 text-lg font-light leading-relaxed">
                  ...
                  <p>
                    Unlike many suppliers who act as middlemen, we are <strong>manufacturers at heart</strong>. With a facility equipped with state-of-the-art machinery and a dedicated team of over 50 skilled employees, we maintain complete control over our production line.
                  </p>
      ...
      {/* 3. THE TRUST MODEL */}
      <section className="bg-brand-gold/5 bg-noise py-32 text-stone-600 relative overflow-hidden">
